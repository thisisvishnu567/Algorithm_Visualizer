...
async function linearSearch(num) {
  ...
  if (foundIndex != -1)
    time.innerHTML = `Element found at index ${foundIndex} <br> Time taken: ${
      (end - start) / 1000
    } Sec`;
  else time.innerHTML = `Element not found`;
